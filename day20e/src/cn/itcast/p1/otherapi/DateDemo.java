...
public class DateDemo {
	...
	public  static void methodDemo_3() throws ParseException {
		...
		Date date = dateFormat.parse(str_date);//【转化抛出异常，因为，可能转化不成功，字符串有误】		
	...
	public static void methodDemo_2() {
		...
		DateFormat dateFormat = DateFormat.getDateInstance(DateFormat.LONG);//【调用静态工厂方法，获取抽象类的对象
...
//		System.out.println(dateFormat);
	 ...
	 *  2，还可以通过setTime设置。 
	 *  因为可以通过Date对象的方法对该日期中的各个字段(年月日等)进行操作。 【获取年】
	 *  
	 * 
	 * 日期对象-->毫秒值：
	 * 	2，getTime方法。
	 * 因为可以通过具体的数值进行运算。 【相加、减】
	 * 
	 * 
	 */
